 ...
 */
public class MyspaceAuth extends LoginAdapter {
    SocialAuthAdapter mAuthAdapter;
    Datastore mDatastore;

    public MyspaceAuth(final Context context) {
        super(context);
...
//                            }
        ...
        mAuthAdapter.addCallBack(SocialAuthAdapter.Provider.MYSPACE, "http://google.com");
    }

    @Override
    public void authorize() {
        mAuthAdapter.authorize(mContext, SocialAuthAdapter.Provider.MYSPACE);
    }

    @Override
    public void signOut() {
        mAuthAdapter.signOut(mContext, SocialAuthAdapter.Provider.MYSPACE.toString());
