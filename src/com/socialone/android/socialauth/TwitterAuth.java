 ...
 */
public class TwitterAuth extends LoginAdapter {
    SocialAuthAdapter mAuthAdapter;
    Datastore mDatastore;

    public TwitterAuth(final Context context) {
        super(context);
...
//                            }
    ...
    @Override
    public void signOut() {
        mAuthAdapter.signOut(mContext, SocialAuthAdapter.Provider.TWITTER.toString());
