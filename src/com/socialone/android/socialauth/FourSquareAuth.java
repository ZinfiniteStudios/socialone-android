 ...
 */
public class FourSquareAuth extends LoginAdapter {
    SocialAuthAdapter mAuthAdapter;
    Datastore mDatastore;

    public FourSquareAuth(final Context context) {
        super(context);
...
//                            }
        ...
        mAuthAdapter.addCallBack(SocialAuthAdapter.Provider.FOURSQUARE, Constants.FOURSQUARE_CALLBACK);
    }

    @Override
    public void authorize() {
        mAuthAdapter.authorize(mContext, SocialAuthAdapter.Provider.FOURSQUARE);
    }

    @Override
    public void signOut() {
        mAuthAdapter.signOut(mContext, SocialAuthAdapter.Provider.FOURSQUARE.toString());
