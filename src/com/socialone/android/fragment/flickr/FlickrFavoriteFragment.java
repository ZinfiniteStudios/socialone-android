 ...
 */
public class FlickrFavoriteFragment extends SherlockFragment{
...
//        List<Photo> photos = f.getInterestingnessInterface().getList(day, Constants.EXTRAS, Constants.FETCH_PER_PAGE, 1);
        List<Photo> photos = f.getFavoritesInterface().getList(user.getId(), null, null, 50, 1, Constants.EXTRAS);
