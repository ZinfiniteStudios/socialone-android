 ...
 */
public class FiveHundNavFragment extends SherlockFragment {
    ...
    FragmentManager fm;
    FiveHundEditorFragment fiveHundEditorFragment = new FiveHundEditorFragment();
    FiveHundPopularFragment fiveHundPopularFragment = new FiveHundPopularFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFragments.add(fiveHundEditorFragment);
        mFragments.add(fiveHundPopularFragment);
    ...
    class PagerAdapter extends FragmentPagerAdapter {
        ...
        public PagerAdapter(Context context, ArrayList<String> strings, ArrayList<Fragment> fragments){
            super(FiveHundNavFragment.this.getChildFragmentManager());
