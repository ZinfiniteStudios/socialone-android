 ...
 */
public class FiveHundEditorFragment extends SherlockFragment {
...
//                .setup(mPullToRefreshLayout);
    ...
    private void setUpFeed() throws Exception {
        ...
        FiveHundEditorService service = restAdapter.create(FiveHundEditorService.class);
        FiveHundEditorService.PhotosResponse response = service.getPopularPhotos();
        ArrayList<FiveHundEditorService.Photo> photos = response.photos;
...
//        }
    ...
    public class GoogleCardsAdapter extends BaseAdapter {
        ...
        private ArrayList<FiveHundEditorService.Photo> mFeed;
        private boolean mShouldReturnEmpty = true;

        public GoogleCardsAdapter(Context context, ArrayList<FiveHundEditorService.Photo> feed) {
            mContext = context;
            mFeed = feed;
        }

        public void setData(ArrayList<FiveHundEditorService.Photo> feed) {
            mFeed = feed;
        }
        ...
        @Override
        public FiveHundEditorService.Photo getItem(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final FiveHundEditorService.Photo feed = getItem(position);
