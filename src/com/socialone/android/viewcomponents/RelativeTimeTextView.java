...
public class RelativeTimeTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.ResizedTextView, 0, 0);
        try {
...
//        setTypeface(tf);
    ...
    /**
     * Sets the reference time for this view. At any moment, the view will render a relative time period relative to the
     * time set here. <p/> This value can also be set with the XML attribute {@code reference_time}
     *
