...
public class ShareActionItem extends LinearLayout {
    ...
    public ShareActionItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        setClickable(true);
        setGravity(Gravity.CENTER_VERTICAL);

        LayoutInflater.from(context).inflate(R.layout.social_share_item, this, true);
    ...
    public ShareActionItem(Context context, int id) {
        super(context);
        setMyId(id);
    }
