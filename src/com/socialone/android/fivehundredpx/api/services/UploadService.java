package com.socialone.android.fivehundredpx.api.services;
...
import com.socialone.android.fivehundredpx.api.tasks.CreatePhotoTask;
import com.socialone.android.fivehundredpx.api.tasks.ImageUploadTask;
...
//                Toast.makeText(this, "success...", Toast.LENGTH_SHORT).show();
    ...
    private void showNotification() {
        ...
        Notification notification = new NotificationCompat.Builder(
                MainApp.getContext()).setContentTitle("service upload ...")
                .build();
